...
namespace urakawa.oldTests
{
    ...
    public class ChannelTests : TestCollectionBase
    {
        ...
        {
            Channel c1Channel = mProject.GetPresentation(0).ChannelsManager.GetManagedObject("c1");
            ...
            mProject.GetPresentation(0).ChannelsManager.RemoveManagedObject(c1Channel);
            mProject.GetPresentation(0).ChannelsManager.AddManagedObject(c1Channel);
            detVis.Reset();
            mProject.GetPresentation(0).RootNode.AcceptDepthFirst(detVis);
            Assert.IsFalse(
                detVis.HasFoundMedia,
