...
namespace NLayer.Decoder
{
    class LayerIDecoder : IFrameDecoder
    {
        ...
        protected OutputChannels which_channels;
        protected int mode;
        ...
        protected void readSampleData()
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    if ((which_channels == (int)OutputChannels.Both) && (mode != Header.SINGLE_CHANNEL))
         ...
         */
        public abstract class Subband // MRH: was static
        {
            /*
	  ...
	  0.00000190734863f, 0.00000151386361f, 0.00000120155435f, 0.00000000000000f /* illegal scalefactor */
         ...
         */
        class SubbandLayer1 : Subband // MRH: was static
        {
	  ...
	  ((1.0f/8192.0f)-1.0f) * (16384.0f/16383.0f), ((1.0f/16384.0f)-1.0f) * (32768.0f/32767.0f)
            ...
            public override void read_allocation(Bitstream stream, Header header, Crc16 crc)
            {
                if ((allocation = stream.get_bits(4)) == 15)
                {
                    ...
                    throw new DecoderException(Errors.ILLEGAL_SUBBAND_ALLOCATION);
         ...
         */
        class SubbandLayer1IntensityStereo : SubbandLayer1 // MRH: was static
        {
         ...
         */
        class SubbandLayer1Stereo : SubbandLayer1 // MRH: was static
        {
