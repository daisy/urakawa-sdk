...
namespace NLayer.Decoder
{
    ...
    sealed class HuffmanDecoder
    {
        ...
        private int reference;			        /* a positive value indicates a reference */
	...
	{0,15},
        ...
        public static HuffmanDecoder[] ht = null;     /* Simulate extern struct                 */
         ...
         */
        private HuffmanDecoder(String S, int XLEN, int YLEN, int LINBITS, int LINMAX, int REF,
