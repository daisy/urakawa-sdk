...
namespace urakawa.media.data.audio.codec
{
    ...
    public class WavAudioMediaDataTests
    {
        ...
        {
            mPresentation.getMediaDataManager().removeMediaData(mData1);
            mPresentation.getMediaDataManager().removeMediaData(mData2);
            mPresentation.getMediaDataManager().removeMediaData(mData3);
        }
        ...
        {
            mData1.appendAudioDataFromRiffWave(getPath("audiotest1-mono-44100Hz-16bits.wav"));
            mData1.getAudioData(new Time(2), new Time(1));
        }
        ...
        {
            mData1.appendAudioDataFromRiffWave(getPath("audiotest1-mono-44100Hz-16bits.wav"));
            mData1.getAudioData(new Time(1), new Time(-1));
        }
