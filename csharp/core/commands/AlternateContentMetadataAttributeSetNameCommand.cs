...
namespace urakawa.commands
{
    public class AlternateContentMetadataAttributeSetNameCommand : Command
    {
        ...
        public void Init(AlternateContentProperty altContentProperty, AlternateContent altContent, Metadata metadata, MetadataAttribute metadataAttribute,string name)
        {
            if (metadata == null)
            {
