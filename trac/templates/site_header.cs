...
<a accesskey="l" href="/urakawa-sdk/login" title="Authenticate yourself to gain write-credentials">Login</a>
 / 
<a href="/urakawa-sdk/logout" title="Log-off to become a anonymous user with read credentials only">Logout</a>
 | 
