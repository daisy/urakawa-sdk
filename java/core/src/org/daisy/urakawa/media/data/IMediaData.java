 ...
 * IMediaData resource. For example, it can be a single file
 * (IFileDataProvider), but it could also be a sequence of various sources (e.g.
 * MemoryDataProvider, MySQLDataProvider, HTTPDataProvider, etc.).
 * 
