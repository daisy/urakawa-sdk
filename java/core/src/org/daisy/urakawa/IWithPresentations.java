...
public interface IWithPresentations {
	 ...
	 * 
	 * @param iPresentation
	 *            cannot be null, must not already be registered by this IProject
	 * @throws MethodParameterIsNullException
	 *             NULL method parameters are forbidden
	 * @throws IsAlreadyManagerOfException
	 *             when the given IPresentation is already managed by this
	 *             IProject
	 */
	 ...
	 *             getNumberOfPresentations()]
	 * @throws IsAlreadyManagerOfException
	 *             when the given IPresentation is already registered in this
	 *             IProject at a different index (nothing happens when trying to
	 *             set a IPresentation where it already is).
