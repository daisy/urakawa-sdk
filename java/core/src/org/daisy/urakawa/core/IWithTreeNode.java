...
/**
 * <p>
 * Getting and Setting the root ITreeNode of a IPresentation. This represents a
 * UML composition relationship, as the IPresentation actually owns the tree of
...
public interface IWithTreeNode
{
     ...
     *         is already part of another IPresentation
     * @throws IsNotInitializedException when the given ITreeNode is not
     *         initialized with its IPresentation reference
     */
