 ...
 */
public interface IWithGenericPropertyFactory {
	/**
	 * @return the factory object. Cannot be null.
	 */
	public IGenericPropertyFactory getCorePropertyFactory();
	 ...
	 */
	public void setCorePropertyFactory(IGenericPropertyFactory factory)
			throws MethodParameterIsNullException;
}
