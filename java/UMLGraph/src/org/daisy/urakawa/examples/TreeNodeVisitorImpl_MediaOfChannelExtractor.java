 ...
 */
public class TreeNodeVisitorImpl_MediaOfChannelExtractor implements TreeNodeVisitor {
     ...
     * @param channelName
     */
    public TreeNodeVisitorImpl_MediaOfChannelExtractor(Presentation presentation, String channelName) {
                ...
                try {
                    ...
                    rootNode.acceptDepthFirst(new TreeNodeVisitor() {
                        public void preVisit(TreeNode node) throws MethodParameterIsNullException {
                            TreeNodeVisitorImpl_MediaOfChannelExtractor.this.preVisit(node);
                        }
    ...
    /**
     * Unused method (empty).
     * It is implemented though, as it's part of the contract expressed by the VisitableTreeNode interface.
     *
     * @param node
     */
