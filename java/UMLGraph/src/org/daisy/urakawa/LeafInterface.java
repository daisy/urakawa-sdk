 ...
 * their reference implementation, and instead, use the matching concrete class
 * directly as a type. However, it is judicious to keep such interface in the
 * API of an SDK reference implementation, if for example, multiple
 * implementations are provided. This is typically applicable if the factory
 * design pattern is used to generate instances of a type, possibly based on
 * several different actual implementations of the type.
 * </p>
 */
