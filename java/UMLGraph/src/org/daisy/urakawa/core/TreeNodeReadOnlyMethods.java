...
public interface TreeNodeReadOnlyMethods {
     ...
     * @return the child TreeNode at a given index. cannot return null, by contract.
    ...
    /**
     * @return the parent of this TreeNode instance. returns NULL is this node is the root of the tree.
     */
     ...
     */
    public int indexOf(TreeNode node) throws TreeNodeDoesNotExistException, MethodParameterIsNullException;
     ...
     */
    public boolean isDescendantOf(TreeNode node) throws MethodParameterIsNullException;
     ...
     * @tagvalue Exceptions "MethodParameterIsNull"
     */
    public boolean isAncestorOf(TreeNode node) throws MethodParameterIsNullException;
     ...
     * @tagvalue Exceptions "MethodParameterIsNull"
     */
    public boolean isSiblingOf(TreeNode node) throws MethodParameterIsNullException;
