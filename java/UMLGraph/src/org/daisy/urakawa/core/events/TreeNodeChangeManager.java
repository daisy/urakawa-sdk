 ...
 * (un-)registration of the {@link TreeNodeChangedListener} event listeners (or
 * specialized {@link TreeNodeAddedRemovedListener},
 * {@link TreeNodeAddedRemovedListener}, etc.), and for dispatching the
 * {@link org.daisy.urakawa.core.TreeNode} change notification to all registered
 * listeners. The {@link TreeNodeChangedEvent} and its specialized sub-types are
 ...
 * {@link TreeNodeChangedEvent}, when it is passed to registered listeners
 ...
 * listeners and the manager by using the generic event middle-man ({@link TreeNodeChangedEvent}).
 ...
 * {@link TreeNodeAddedRemovedListener}, {@link TreeNodeAddedEvent} and
 ...
 * {@link TreeNodeChangedEvent} and its specialized sub-types as containers for
