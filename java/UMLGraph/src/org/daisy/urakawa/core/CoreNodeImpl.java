...
public class CoreNodeImpl implements CoreNode {
	 ...
	 * @hidden
	 */
	public void acceptDepthFirst(CoreNodeVisitor visitor)
	 ...
	 * @hidden
	 */
	public int indexOf(CoreNode node) throws NodeDoesNotExistException,
	 ...
	 * @hidden
	 */
	public boolean isDescendantOf(CoreNode node)
			throws MethodParameterIsNullException {
		return false;
	}
	 ...
	 * @hidden
	 */
	public boolean isAncestorOf(CoreNode node)
			throws MethodParameterIsNullException {
		return false;
	}
	 ...
	 * @hidden
	 */
	public boolean isSiblingOf(CoreNode node)
			throws MethodParameterIsNullException {
		return false;
	}
	 ...
	 * @hidden
	 */
	public void removeChild(CoreNode node) throws NodeDoesNotExistException,
			MethodParameterIsNullException {
	}
	 ...
	 * @hidden
	 */
	public CoreNode splitChildren(int index, boolean copyProperties)
			throws MethodParameterIsOutOfBoundsException {
		return null;
	}
	 ...
	 * @hidden
	 */
	public void replaceChild(CoreNode node, CoreNode oldNode)
			throws NodeDoesNotExistException, MethodParameterIsNullException {
	}
	...
	public void appendChildrenOf(CoreNode node)
			throws MethodParameterIsNullException,
			NodeIsInDifferentPresentationException, NodeIsAncestorException,
			NodeIsSelfException {
	}
	 ...
	 * @hidden
	 */
	public void swapWith(CoreNode node) throws MethodParameterIsNullException,
			NodeIsInDifferentPresentationException, NodeIsAncestorException,
			NodeIsSelfException, NodeIsDescendantException {
	}
	 ...
	 * @hidden
	 */
	public void acceptBreadthFirst(CoreNodeVisitor visitor)
			throws MethodParameterIsNullException {
	}
	 ...
	 * @hidden
	 */
	public boolean ValueEquals(CoreNode other)
			throws MethodParameterIsNullException {
		return false;
	}
}
