...
import org.daisy.urakawa.events.property.xml.QNameChangedEvent;
import org.daisy.urakawa.events.property.xml.XmlAttributeSetEvent;
...
public class XmlProperty extends Property implements IXmlProperty
{
            ...
            throws MethodParameterIsNullException
    {
        ...
        if (QNameChangedEvent.class.isAssignableFrom(klass))
        {
            ...
            if (XmlAttributeSetEvent.class.isAssignableFrom(klass))
            {
            ...
            throws MethodParameterIsNullException
    {
        ...
        if (QNameChangedEvent.class.isAssignableFrom(klass))
        {
            ...
            if (XmlAttributeSetEvent.class.isAssignableFrom(klass))
            {
                mXmlAttributeSetEventNotifier.unregisterListener(listener,
                        klass);
            }
            else
            {
            ...
            MethodParameterIsNullException, ProgressCancelledException
    {
        ...
        if (source.getLocalName() == XmlAttribute.class.getSimpleName()
