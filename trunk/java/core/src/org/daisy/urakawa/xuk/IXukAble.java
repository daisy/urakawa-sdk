 ...
 * (see {@link IXukAble#xukIn(IXmlDataReader, IProgressHandler)}) the Urakawa
 * data model to / from the XUK XML format. This enables safe round-trip
 * engineering for all object classes of the data model that are persistent in
 * the XUK format.
 * </p>
 * <p>
