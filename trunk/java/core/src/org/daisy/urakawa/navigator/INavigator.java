...
public interface INavigator
{
     ...
     * 
     * @param node
     *        the base node for which to return the parent. Cannot be NULL, and
     *        must be part of the forest (must be included by the navigator).
     ...
     * 
     * @param node
     *        the base node for which to return the children. Cannot be NULL,
     ...
     * 
     * @param node
     *        the base node for which to return the child. Cannot be NULL, and
     *        must be part of the forest (must be included by the navigator).
     * @param index
     *        must be a value between 0 and getNumberOfChildren(node)-1, in the
     *        context of this navigator.
     ...
     * 
     * @param node
     *        the base node for which to return the sibling. Cannot be NULL, and
     *        must be part of the forest (must be included by the navigator).
     ...
     * 
     * @param node
     *        the base node for which to return the next node. Cannot be NULL,
     *        but is not necessarily part of the forest (not included by the
     *        navigator).
