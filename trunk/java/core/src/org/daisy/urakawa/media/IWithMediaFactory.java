 ...
 * @depend - Aggregation 1 org.daisy.urakawa.media.IMediaFactory
 */
public interface IWithMediaFactory {
	/**
	 * @return the factory object. Cannot be null, because an instance is
	 *         created lazily via the IDataModelFactory when setMediaFactory()
