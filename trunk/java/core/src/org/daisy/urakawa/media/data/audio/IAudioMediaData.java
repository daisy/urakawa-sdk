...
public interface IAudioMediaData extends IMediaData
{
     ...
     * 
     * @param newFormat the format to test
     ...
     * 
     * @param newFormat cannot be null
     * 
     ...
     * 
     * @param riffWaveStream cannot be null.
     * 
     * @throws MethodParameterIsNullException NULL method parameters are
     *         forbidden
     * @throws InvalidDataFormatException
     ...
     * Appends audio data from a RIFF Wave file
     * 
     * @param path cannot be null or empty string.
     * 
     * @throws MethodParameterIsNullException NULL method parameters are
     *         forbidden
     ...
     * 
     * @param riffWaveStream cannot be null.
     * @param insertPoint cannot be null.
     * @param duration cannot be null.
     * @throws MethodParameterIsNullException
     * @throws InvalidDataFormatException
     * @throws TimeOffsetIsOutOfBoundsException
     * @throws IOException
     ...
     * 
     * @param riffWaveStream cannot be null.
     * @param replacePoint cannot be null.
     * @param duration cannot be null.
     * @throws MethodParameterIsNullException
     * @throws InvalidDataFormatException
     * @throws TimeOffsetIsOutOfBoundsException
