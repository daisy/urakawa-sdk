...
public interface IAudioMediaData extends IMediaData {
	 ...
	 * @throws MethodParameterIsNullException 
	 */
	public int getPCMLength(ITimeDelta duration) throws TimeOffsetIsOutOfBoundsException, MethodParameterIsNullException;
	 ...
	 * retaining the audio before the split point, creating a new IAudioMediaData
	...
	/**
	 * Gets an input IStream giving access to the audio data after the given ITime
	 * as raw PCM. Make sure to close any audio IStream returned by this method
