        ...
        IManagedAudioMedia
{
    ...
    @Override
    public IManagedAudioMedia export(Presentation destPres)
            throws MethodParameterIsNullException
    {
        if (destPres == null)
        {
            ...
            TimeOffsetIsOutOfBoundsException
    {
        ...
        try
        {
            copyMAM = (IManagedAudioMedia) getPresentation().getMediaFactory()
            ...
            TimeOffsetIsOutOfBoundsException
    {
        ...
        try
        {
            oSecondPart = getPresentation().getMediaFactory().create(
