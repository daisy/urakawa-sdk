...
sed -e 's/align="right"/align="center"/g' -e 's/}Notes}//g' -e 's/{Notes = {//g' -e 's/node \[/node \[color=\"Gray\",/g' -e 's/edge \[/edge \[color=\"Gray\",/g' ViewMedia.dot | cat > ViewMedia_.dot
sed -e 's/align="right"/align="center"/g' -e 's/}Notes}//g' -e 's/{Notes = {//g' -e 's/node \[/node \[color=\"Gray\",/g' -e 's/edge \[/edge \[color=\"Gray\",/g' ViewCoreDataModel.dot | cat > ViewCoreDataModel_.dot
sed -e 's/align="right"/align="center"/g' -e 's/}Notes}//g' -e 's/{Notes = {//g' -e 's/node \[/node \[color=\"Gray\",/g' -e 's/edge \[/edge \[color=\"Gray\",/g' ViewFullUML.dot | cat > ViewFullUML_.dot
sed -e 's/align="right"/align="center"/g' -e 's/}Notes}//g' -e 's/{Notes = {//g' -e 's/node \[/node \[color=\"Gray\",/g' -e 's/edge \[/edge \[color=\"Gray\",/g' ViewExceptions.dot | cat > ViewExceptions_.dot
