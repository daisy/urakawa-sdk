 ...
 * @match class org.daisy.urakawa.Presentation
 * @opt !hide
 * @match class org.daisy.urakawa.media.*XukAble
 * @opt !hide
 * @match class org.daisy.urakawa.media.*With.*XukAble
 * @opt hide
 * @match class org.daisy.urakawa.media.data.*
 * @opt hide
 * @comment Un-hiding some media data entities:
 ...
 * @match class org.daisy.urakawa.Presentation
 * @opt !hide
 * @match class org.daisy.urakawa.media.data.*XukAble
 * @opt !hide
 * @match class org.daisy.urakawa.media.data.*With.*XukAble
 * @opt hide
 */
