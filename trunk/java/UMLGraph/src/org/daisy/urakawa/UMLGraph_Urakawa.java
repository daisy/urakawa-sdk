 ...
 * @opt !hide
 */
class ViewStickyNote extends ViewBase {
}
 ...
 * @match class org.daisy.urakawa.StickyNotes
 * @opt hide
 * @match class org.daisy.urakawa.visitor.CoreNodeVisitor
 * @opt !hide
 * @match class org.daisy.urakawa.IdentifiableInterface
 * @opt hide
 * @match class org.daisy.urakawa.InterfaceID
 ...
 * @view
 * @opt hide
 * @match class org.daisy.urakawa.core.properties.*
 * @opt !hide
 * @match class org.daisy.urakawa.core.properties.xml.*
 * @opt hide
 * @match class org.daisy.urakawa.core.properties.channels.*
 * @opt hide
 * @match class org.daisy.urakawa.StickyNotes
 * @opt hide
