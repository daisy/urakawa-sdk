...
public interface WithPresentations {
	/**
	 * Creates a new Presentation with the DataModelFactory and adds it to the
	 * Project. Also returns the new instance.
	 * 
	 * @return the new Presentation created with the DataModelFactory
	 */
	 ...
	 *             when the given Presentation is already managed by this
	 *             Project
	 */
