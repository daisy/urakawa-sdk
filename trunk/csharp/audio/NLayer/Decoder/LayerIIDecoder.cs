...
namespace NLayer.Decoder
{
    ...
    class LayerIIDecoder : LayerIDecoder, IFrameDecoder
    {
         ...
         */
        class SubbandLayer2 : Subband // MRH: was static
        {
	...
	{ 0.0f,           0.50000000000f, 0.50000000000f, 0.25000000000f, 0.50000000000f,
	  ...
	  0.00003051758f };
            ...
            public static readonly float[] table_ab3_factor = { 0.0f, 1.0f / 2.0f, 1.0f / 4.0f, 1.0f / 4.0f, 1.0f / 8.0f, 1.0f / 8.0f, 1.0f / 16.0f, 1.0f / 32768.0f };
	...
	{ 0.0f,           0.50000000000f, 0.50000000000f, 0.50000000000f, 0.12500000000f,
	  ...
	  0.00006103516f };
         ...
         */
        class SubbandLayer2IntensityStereo : SubbandLayer2 // MRH: was static
        {
            ...
            public override bool put_next_sample(OutputChannels channels, SynthesisFilter filter1, SynthesisFilter filter2)
            {
                if (allocation != 0)
                {
                    ...
                    else if (channels == OutputChannels.Left)
                    {
                        if (groupnumber <= 4)
                            sample *= scalefactor1;
                        else if (groupnumber <= 8)
         ...
         */
        class SubbandLayer2Stereo : SubbandLayer2 // MRH: was static
        {
