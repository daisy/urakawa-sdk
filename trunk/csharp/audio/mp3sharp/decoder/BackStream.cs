...
namespace javazoom.jl.decoder
{
	...
	internal class CircularByteBuffer 
	{
		...
		{
            ////System.Diagnostics.Trace.WriteLine("BackStream - Push - start");
			byte ret;
			lock(this)
			{
                ////System.Diagnostics.Trace.WriteLine("BackStream - Push - InternalGet");
            ...
            ////System.Diagnostics.Trace.WriteLine("BackStream - Push - end");
			return ret;
		}
		...
		{
            ////System.Diagnostics.Trace.WriteLine("BackStream - InternalGet - start");
			...
			// Set value
            ////System.Diagnostics.Trace.WriteLine("BackStream - InternalGet - end");
