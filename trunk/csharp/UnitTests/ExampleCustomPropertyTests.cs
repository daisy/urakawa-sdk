	...
	[TestFixture] public class ExampleCustomTests
	{
		...
		[SetUp] public void Init() 
		{
			...
			mProject = new Project(
				new Presentation(fileUri, new ExampleCustomTreeNodeFactory(), new ExampleCustomPropertyFactory(), null, null, null, null, null, null),
				null);
		...
		[Test] public void TestExCustPropSaved()
		{
			...
			Project reloadedProject = new Project(
				new Presentation(mProject.getPresentation().getBaseUri(), new ExampleCustomTreeNodeFactory(), new ExampleCustomPropertyFactory(), null, null, null, null, null, null),
				null);
