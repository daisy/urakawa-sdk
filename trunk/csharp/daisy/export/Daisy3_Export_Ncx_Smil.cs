...
namespace urakawa.daisy.export
{
    public partial class Daisy3_Export
    {
        ...
        private void CreateNcxAndSmilDocuments()
        {
            ...
            reportProgress ( m_ProgressPercentage, "Creating smil and ncx files" );
            ...
            if (RequestCancellation) return false;
                ...
                */
                ...
                if (smilDocument == null)
                {
                    ...
                    reportProgress ( m_ProgressPercentage, "Creating smil files " + m_SmilFileNameCounter.ToString () + "//" + m_ListOfLevels.Count.ToString() );
                }
