            ...
            bool noAudioLocal = (levelNodeDescendant.GetManagedAudioMediaOrSequenceMedia() == null);
                    ...
                    levelNodeDescendant.GetXmlElementLocalName() == "pagenum")
                {
                    ...
                    if (externalAudio != null)
                    {
                        ...
                        XmlDocumentHelper.CreateAppendXmlAttribute(ncxDocument, audioNodeNcx, "src", FileDataProvider.UriEncode(Path.GetFileName(externalAudio.Src)));
                    }
                ...
                if (specialNodeIsNoteAnnoRef)
                {
                    ...
                    Time time = CreateFollowupNoteAndAnnotationNodes(smilDocument, smilBodySeq,
                                                                     specialNodeReferredNoteAnno, smilFileName,
                                                                     currentSmilCustomTestList, ncxCustomTestList);

                    durationOfCurrentSmil.Add(time);
