 ...
 * the preVisit() and postVisit() methods of the TreeNodeVisitor before and
 * after traversing the children nodes, respectively. The VisitableTreeNode
 * implementation only handles the tree traversal, the actual business logic
 * action associated to the node is handled by TreeNodeVisitor implementations.
 * </p>
 * <p>
...
public interface VisitableTreeNode {
	 ...
	 * postVisit() methods of the TreeNodeVisitor before and after recursively
